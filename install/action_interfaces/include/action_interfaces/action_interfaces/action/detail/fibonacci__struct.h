...
enum
{
  action_interfaces__action__Fibonacci_SendGoal_Event__request__MAX_SIZE = 1
};
// response
enum
{
  action_interfaces__action__Fibonacci_SendGoal_Event__response__MAX_SIZE = 1
};

/// Struct defined in action/Fibonacci in the package action_interfaces.
typedef struct action_interfaces__action__Fibonacci_SendGoal_Event
{
  service_msgs__msg__ServiceEventInfo info;
  action_interfaces__action__Fibonacci_SendGoal_Request__Sequence request;
  action_interfaces__action__Fibonacci_SendGoal_Response__Sequence response;
} action_interfaces__action__Fibonacci_SendGoal_Event;

// Struct for a sequence of action_interfaces__action__Fibonacci_SendGoal_Event.
typedef struct action_interfaces__action__Fibonacci_SendGoal_Event__Sequence
{
...
enum
{
  action_interfaces__action__Fibonacci_GetResult_Event__request__MAX_SIZE = 1
};
// response
enum
{
  action_interfaces__action__Fibonacci_GetResult_Event__response__MAX_SIZE = 1
};

/// Struct defined in action/Fibonacci in the package action_interfaces.
typedef struct action_interfaces__action__Fibonacci_GetResult_Event
{
  service_msgs__msg__ServiceEventInfo info;
  action_interfaces__action__Fibonacci_GetResult_Request__Sequence request;
  action_interfaces__action__Fibonacci_GetResult_Response__Sequence response;
} action_interfaces__action__Fibonacci_GetResult_Event;

// Struct for a sequence of action_interfaces__action__Fibonacci_GetResult_Event.
typedef struct action_interfaces__action__Fibonacci_GetResult_Event__Sequence
{
