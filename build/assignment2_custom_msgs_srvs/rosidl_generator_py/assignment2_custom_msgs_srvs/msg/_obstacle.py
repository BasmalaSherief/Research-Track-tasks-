    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'assignment2_custom_msgs_srvs.msg.Obstacle')
            logger.debug(
...
class Obstacle(metaclass=Metaclass_Obstacle):
    ...
    def __init__(self, **kwargs):
        ...
        self.obstacle_direction = kwargs.get('obstacle_direction', str())
    ...
    def obstacle_direction(self, value):
        if self._check_fields:
            assert \
                ...
                "The 'obstacle_direction' field must be of type 'str'"
