...
bool assignment2_custom_msgs_srvs__msg__obstacle__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("assignment2_custom_msgs_srvs.msg._obstacle.Obstacle", full_classname_dest, 51) == 0);
  }
  assignment2_custom_msgs_srvs__msg__Obstacle * ros_message = _ros_message;
  {  // obstacle_distance
  ...
  {  // obstacle_direction
    ...
    rosidl_runtime_c__String__assign(&ros_message->obstacle_direction, PyBytes_AS_STRING(encoded_field));
...
PyObject * assignment2_custom_msgs_srvs__msg__obstacle__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("assignment2_custom_msgs_srvs.msg._obstacle");
  ...
  {  // obstacle_direction
    ...
    field = PyUnicode_DecodeUTF8(
      ros_message->obstacle_direction.data,
      strlen(ros_message->obstacle_direction.data),
      "replace");
    if (!field) {
      return NULL;
    }
